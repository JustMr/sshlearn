	 ...
	 <s:form action="addBrand">  
		<table id="upBrtable">
  			...
  			<tr><td><label>英文名称:</label></td></tr> 
		   	...
		   	<tr>
		   		<td class="upBrFont"><s:radio name="brandAD.brState" list="#{'停售':0,'正常':1,'促销':2,'开通中':3}" label="状态" listKey="value" listValue="key" value="1"/></td>
		   	</tr>  
		   	<tr><td><label>评级:</label></td></tr>
		   	<tr>
		   		<td class="upBrFont"><s:radio name="brandAD.brLevelGrand" list="#{'恶劣':0,'不良':1,'普通':2,'较好':3,'优秀':4}" label="评级" listKey="value" listValue="key" value="2"></s:radio></td>
		   	</tr>  
		   	<tr>
