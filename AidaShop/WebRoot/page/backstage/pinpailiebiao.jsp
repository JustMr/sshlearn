  	...
  	<form  id="myForm">
		<table id="brandListTAb" cellspacing="0">  
			...
			<tbody>  
			 ...
			 <tr class="bhover">  
			  <td>  
			   <input type="checkbox" name="brIds" value='<s:property value="brId" />' />  
			  </td>  
			  <td>  
			   <a href='<s:url action="editBrand"><s:param  name="brId" value="brId" /></s:url>'><s:property value="brId" /></a>  
			  </td>  
			  ...
			  <td>  
			   <a class="brandEdit" title="编辑" href='<s:url action="editBrand"><s:param name="brId" value="brId" /></s:url>'></a> 
			  </td>  
			 </tr>  
			</s:iterator>  
		 	</tbody>  
