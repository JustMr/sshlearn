...
<html>
  ...
  <body>
    <div id="zygl_info">
    	<p>
    		<span>用户名：</span>
    		<span id="zygl_infoName">${cusNickName}</span>	
    	</p>
    	<p>
    		<span>用户权限：</span>
    		<span id="zygl_infoQuanxian"></span>
    	</p>
    	<p>
    		<span>最近登录时间：</span>
    		<span id="zygl_infoTime"></span>
    	</p>
    	<p>
    		<span>最近登录地点：</span>
    		<span id="zygl_infoPlace"></span>
    	</p>
    </div>
    <div id="zygl_logRecord">
    	...
    	<div id="recordName" class="logRecord">
    		<h5>用户ID</h5>
    		<div id="nameItem" class="recitem">
    		
    		</div>
    	</div>
    	<div id="recordTime" class="logRecord">
    		<h5>时间</h5>
    		<div id="timeItem" class="recitem">
    		
    		</div>
    	</div>
    	<div id="recordAddress" class="logRecord">
    		<h5>IP地址</h5>
    		<div id="addressItem" class="recitem">
    		
    		</div>
    	</div>
    	<div id="recordSite" class="logRecord">
    		<h5>地点</h5>
    		<div id="siteItem" class="recitem">
